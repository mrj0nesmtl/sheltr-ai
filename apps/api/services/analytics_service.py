...
class AnalyticsService:
    ...
    async def _get_donation_metrics(self) -> Dict[str, Any]:
        ...
        try:
            # Note: This is mock data since we don't have a donations collection yet
            # In a real implementation, we'd query the donations collection
            ...
            return {
                ...
                "growth_rate": 15.4,
                "top_donors": [
                    {"name": "Anonymous Donor", "amount": 5000.00},
                    {"name": "Community Foundation", "amount": 2500.00},
                    {"name": "Local Business", "amount": 1800.00}
                ]
            }
