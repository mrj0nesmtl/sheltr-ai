            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <a href="https://github.com/mrj0nesmtl/sheltr-ai/blob/main/docs/features/knowledge-base/KNOWLEDGE-BASE-UPDATE-GUIDE.md" target="_blank" rel="noopener noreferrer">
