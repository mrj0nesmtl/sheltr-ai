        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://github.com/mrj0nesmtl/sheltr-ai/blob/main/docs/architecture/payment-rails/sheltr-unified-payment-architecture.md" target="_blank" rel="noopener noreferrer">
