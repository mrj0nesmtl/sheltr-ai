...
const investmentSlides = [
  ...
  },
  {
    ...
    content: {
      ...
      milestones: [
        'Q4 2025: Beta platform launch',
        'Q1 2026: First shelter partnerships',
        'Q2 2026: Enterprise payment integration',
        'Q4 2026: Scale to 50+ shelters'
      ]
    }
  },
  {
...
export default function IRInvestorRelationsPage() {
  ...
  const { heroImage } = useHeroImage('/ir/investor-relations', '/backgrounds/hero-bg.jpg');
  ...
  const tokenProjections = [
    { year: 2026, users: 2500, transactions: 125000, tokenValue: 0.10, marketCap: 250000, phase: 'Beta Launch' },
    { year: 2027, users: 10000, transactions: 500000, tokenValue: 0.25, marketCap: 2500000, phase: 'Market Expansion' },
    { year: 2028, users: 25000, transactions: 1250000, tokenValue: 0.50, marketCap: 12500000, phase: 'Scale Phase' },
    { year: 2029, users: 50000, transactions: 2500000, tokenValue: 0.85, marketCap: 42500000, phase: 'International' },
    { year: 2030, users: 100000, transactions: 5000000, tokenValue: 1.20, marketCap: 120000000, phase: 'Market Leader' }
  ];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Verifying founder access...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center flex-wrap gap-1 sm:gap-2 text-sm text-muted-foreground">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                onClick={() => window.location.href = '/ir/dataroom'}
                className="hover:bg-muted px-2 py-1 h-auto text-xs sm:text-sm"
              >
                Data Room
              </Button>
              ...
              <Card className="border-2 border-emerald-500/30 bg-gradient-to-br from-emerald-50/50 to-blue-50/50 dark:from-emerald-900/10 dark:to-blue-900/10">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link href="/ir/budget" className="flex-1">
                    ...
                    <Link href="/ir/revenue" className="flex-1">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-emerald-50 to-blue-50 dark:from-emerald-900/20 dark:to-blue-900/20 rounded-lg">
                      ...
                      <div className="grid grid-cols-5 gap-2">
                        {[
                          { year: '2026', roi: '1x', valuation: '$3M', label: 'Pre-Seed' },
                          { year: '2027', roi: '3x', valuation: '$8M', label: 'Seed Round' },
                          { year: '2028', roi: '6x', valuation: '$18M', label: 'Series A' },
                          { year: '2029', roi: '10x', valuation: '$30M', label: 'Growth' },
                          { year: '2030', roi: '15x', valuation: '$45M', label: 'Scale' }
                        ].map((item, index) => (
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { year: 2026, users: 500, arr: 50000, valuation: 3000000, phase: 'Platform Launch' },
                        { year: 2027, users: 2500, arr: 500000, valuation: 8000000, phase: 'Market Expansion' },
                        { year: 2028, users: 8000, arr: 2000000, valuation: 18000000, phase: 'Scale Phase' },
                        { year: 2029, users: 20000, arr: 5000000, valuation: 30000000, phase: 'Growth Phase' },
                        { year: 2030, users: 50000, arr: 12000000, valuation: 45000000, phase: 'Market Leader' }
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-emerald-50 to-blue-50 dark:from-emerald-900/20 dark:to-blue-900/20 rounded-lg">
                      ...
                      <div className="grid grid-cols-5 gap-2">
                        {[
                          { year: '2026', arr: 50000, label: '$50K' },
                          { year: '2027', arr: 500000, label: '$500K' },
                          { year: '2028', arr: 2000000, label: '$2M' },
                          { year: '2029', arr: 5000000, label: '$5M' },
                          { year: '2030', arr: 12000000, label: '$12M' }
                        ].map((projection, index) => (
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-6 text-sm text-slate-400">
            <span>© 2026 SHELTR Technologies Inc.</span>
            <span>•</span>
