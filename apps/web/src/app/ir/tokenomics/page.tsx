        ...
        <nav className="bg-background/95 backdrop-blur-sm border-b sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <Link href="/ir/dataroom" className="text-2xl font-bold">SHELTR</Link>
      ...
      {!isEmbedded && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            <Link href="/ir" className="hover:text-primary">Investor Relations</Link>
            <span>/</span>
            <Link href="/ir/dataroom" className="hover:text-primary">Data Room</Link>
            <span>/</span>
...
export default function IRIRTokenomicsPage() {
  return (
    <Suspense fallback={
