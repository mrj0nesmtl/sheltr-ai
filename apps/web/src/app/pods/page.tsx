          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/pods" className="text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">
                  PODS
                </Link>
          ...
          {isMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
                ...
                <Link href="/pods" className="text-primary block px-3 py-2 rounded-md text-base font-medium transition-colors">
                  PODS
                </Link>
