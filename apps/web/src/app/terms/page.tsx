          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="border-2">
              <CardContent className="p-6 sm:p-8 lg:p-12">
                ...
                >
              <h2 className="!mt-0 !font-bold !text-3xl">1. Acceptance of Terms</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">2. Platform Description</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">3. User Eligibility</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">4. User Accounts and Verification</h2>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">5. Token Economics and Risks</h2>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">6. Artificial Intelligence and Automated Systems</h2>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">7. Platform Services and Limitations</h2>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">8. Prohibited Activities</h2>
              <p>
                Users may not:
              </p>
              <ul>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">9. Privacy and Data Protection</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">10. Intellectual Property</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">11. Disclaimer of Warranties</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">12. Limitation of Liability</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">13. Indemnification</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">14. Termination</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">15. Dispute Resolution</h2>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">16. Changes to Terms</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">17. Contact Information</h2>
              <p>
              ...
              <h2 className="!mt-16 !font-bold !text-3xl">18. Severability</h2>
              <p>
                If any provision of these Terms is found to be unenforceable, 
                the remaining provisions shall remain in full force and effect.
              </p>

              <h2 className="!mt-16 !font-bold !text-3xl">19. Entire Agreement</h2>
              <p>
