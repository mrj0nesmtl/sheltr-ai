...
export default function ParticipantUserJourney() {
  const { heroImage } = useHeroImage('/user-journeys/participants', '/backgrounds/hero-bg.jpg');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-gray-800">
      <StandardHero
        ...
        title={<>Participant <span className="text-green-400">Journey</span></>}
        subtitle="Your path to stability, dignity, and independence through SHELTR"
      />
