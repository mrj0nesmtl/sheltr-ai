                      ...
                      <ReactMarkdown
                        ...
                        components={{
                          ...
                          blockquote: ({node, ...props}) => (
                            <blockquote className="border-l-4 border-blue-600 pl-3 italic my-2 text-gray-700 dark:text-gray-300" {...props} />
                          ),
                          ...
                          th: ({node, ...props}) => <th className="px-3 py-2 text-left text-xs font-medium text-gray-700 dark:text-gray-300" {...props} />,
                          td: ({node, ...props}) => <td className="px-3 py-2 text-xs text-gray-900 dark:text-gray-100" {...props} />,
                        }}
                      >
                        {message.text}
                      </ReactMarkdown>
