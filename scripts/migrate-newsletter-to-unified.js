 ...
 * 
 * Usage: node scripts/migrate-newsletter-to-unified.js
 */
...
Usage:
  node scripts/migrate-newsletter-to-unified.js [options]
...
Examples:
  ...
  node scripts/migrate-newsletter-to-unified.js --dry-run

  # Run actual migration
  node scripts/migrate-newsletter-to-unified.js

  # Restore from backup (emergency)
  node scripts/migrate-newsletter-to-unified.js --restore
